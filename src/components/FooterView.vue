<template>
 ...
 <footer>
      <div class="container">
        ...
        <!-- right -->
        <div class="col-lg-12 col-md-12 text-start px-5">
          <!-- my contact info -->
          <div id="contact-info" class="container px-5 py-5">
            <div class="row justify-content-center">
                <h1 class="text-white text-center pb-2">Get in touch.</h1>
              <!-- phone no -->
